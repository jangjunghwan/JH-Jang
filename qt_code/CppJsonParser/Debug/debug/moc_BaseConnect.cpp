...
#include "../../JsonParser/BaseConnect.h"
...
QT_MOC_LITERAL(1, 12, 12), // "connectPrint"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "sendCode"
QT_MOC_LITERAL(4, 35, 10) // "getMessage"

    },
    "BaseConnect\0connectPrint\0\0sendCode\0"
    "getMessage"
};
...
void BaseConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectPrint((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendCode((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getFunMessage(); break;
        default: break;
        }
